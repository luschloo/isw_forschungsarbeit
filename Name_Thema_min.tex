...
\begin{document} 
	...
	Das Lastenheft wird in Muss- und Kann-Kriterien unterteilt. Während bei den Muss-Kriterien eine Erfüllung essentiell ist, stellen die Kann-Kriterien eine optionale Erweiterung dar, die dem System jedoch einen Mehrwert verschaffen.\\
		...
		1 & Feldbus Kommunikation zwischen Stäubli-Roboter und SPS & M  \\  
		1 & Einsatz von mehreren Stäubli-Robotern zeitgleich soll möglich sein & M  \\
		1 & Darstellung der Fehlermeldungen des Stäubli-Roboters für den Nutzer & M  \\ 
		1 & Fehlerfreie und prozesssichere Kommunikation & M  \\ 
		\hline
		2 & A (CpuUsage) & - \\
		3 & A (CpuUsage) & - \\	
		\hline
