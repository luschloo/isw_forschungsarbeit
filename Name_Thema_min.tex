...
\begin{document} 
	...
	Standardmäßig wird jedoch sowohl die Beckhoff-SPS, als auch der Stäubli Roboter als Master eingesetzt.
	EtherCAT ist rein für Master-Slave-Kommunikation ausgelegt. https://www.sps-forum.de/threads/ethercat-master-to-master-kommunikation.37904/ 
	
	Beckhoff bietet jedoch eine spezielle Bridge-Klemmen an, um zwei Master-Systeme zu koppeln. Hierdurch entstehen jedoch zusätzliche Kosten und auch die Komplexität des Systems steigt. Da sowohl die Stäubli-Steuerung, als auch die SPS ebenso als Slave konfiguriert werden kann, entfällt die Entscheidung auf die Master-Slave-Kommunikation, um die zusätzliche Master-Master-Klemme einzusparen.
	
	https://www.beckhoff.com/de-de/produkte/i-o/ethercat-klemmen/el6xxx-kommunikation/el6695.html?
